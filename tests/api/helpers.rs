...
impl TestApp {
    ...
    pub fn get_confirmation_links(&self, email_request: &wiremock::Request) -> ConfirmationLinks {
        ...
        let get_link = |s: &str| {
            ...
            let mut confirmation_links = reqwest::Url::parse(&raw_link).unwrap();
            assert_eq!(confirmation_links.host_str().unwrap(), "127.0.0.1");
            confirmation_links.set_port(Some(self.port)).unwrap();
            confirmation_links
        };
